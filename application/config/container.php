...
return array(
	...
	*/
	...
	'esoTalk.plugins' => array('singleton' => true, 'resolver' => function($c)
	{
		return new esoTalk\Packages(ADDON_PATH.'plugins/', 'plugin');
	}),

	'esoTalk.skins' => array('singleton' => true, 'resolver' => function($c)
	{
		return new esoTalk\Packages(ADDON_PATH.'skins/', 'skin');
	}),

	'esoTalk.languages' => array('singleton' => true, 'resolver' => function($c)
	{
		return new esoTalk\Packages(ADDON_PATH.'languages/', 'language');
	}),
