...
function index($channelSlug = false)
{
	...
	$gambits = array(
		__("gambit.active last ? hours") => "gambit-activeLastHours",
		__("gambit.active last ? days") => "gambit-activeLastDays",
		__("gambit.active today") => "gambit-activeToday",
		...
		__("gambit.has replies") => "gambit-hasReplies",
		__("gambit.has >10 replies") => "gambit-replies",
		__("gambit.locked") => "gambit-locked",
		__("gambit.more results") => "gambit-more",
		__("gambit.order by newest") => "gambit-orderByNewest",
		__("gambit.order by replies") => "gambit-orderByReplies",
