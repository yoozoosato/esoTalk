...
ET::$languageInfo["Japanese"] = array(
	"locale" => "ja-JP",
	"name" => "日本語",
	"description" => "普通のWEBサイト向け日本語",
	"version" => ESOTALK_VERSION,
	"author" => "SATO Yozo",
	"authorEmail" => "yoozoosato@gmail.com",
	"authorURL" => "http://twitter.com/yoozoosato",
	"license" => "GPLv2"
);
...
$definitions["%d month ago"] = "1ヶ月前";
$definitions["%d months ago"] = "%dヶ月前";
...
$definitions["%s can view this conversation."] = "このスレは %s が閲覧できます。";
...
$definitions["%s will be able to view this conversation."] = "このスレは %s が閲覧できます。";
...
$definitions["Add"] = "追加";
$definitions["Administration"] = "管理メニュー";
...
$definitions["All Channels"] = "全てのチャンネル";
...
$definitions["Avatar"] = "アイコン";

$definitions["Back to channels"] = "チャンネルに戻る";
$definitions["Back to conversation"] = "会話に戻る";
...
$definitions["Change avatar"] = "アイコンを変更";
$definitions["Change channel"] = "チャンネル変更";
$definitions["Change name"] = "Change name";
$definitions["Change Password or Email"] = "メールアドレス / パスワードの変更";
...
$definitions["Discard Draft"] = "下書きを削除";

$definitions["Edit Channel"] = "チャンネル編集";
...
$definitions["Enter a conversation title"] = "スレタイを書いてね";
...
$definitions["Filter conversations..."] = "スレをフィルタ";
...
$definitions["Jump to last"] = "直近の返信へ移動";
$definitions["Jump to unread"] = "未読へ移動";
...
$definitions["Last active %s"] = "最終アクセス %s";
...
$definitions["Mark all as read"] = "全て既読に";
...
$definitions["Members Allowed to View this Conversation"] = "このスレの閲覧を許可するメンバー";
...
$definitions["Mute conversation"] = "スレをミュート";
...
$definitions["New Conversation"] = "新規スレ立て";
$definitions["New conversations in the past week"] = "この1週間に立ったスレ";
...
$definitions["Post a Reply"] = "返信を書く";
...
$definitions["Remove avatar"] = "アイコンを削除";
$definitions["Rename Member"] = "Rename Member";
$definitions["Reply"] = "Reply";
$definitions["Report a bug"] = "バグを報告";
...
$definitions["Save Draft"] = "下書きとして保存";
$definitions["Search conversations..."] = "Search conversations...";
$definitions["Search within this conversation..."] = "このスレ内を検索";
...
$definitions["statistic.online.plural"] = "%s人がオンライン";
$definitions["statistic.online"] = "%s人がオンライン";
$definitions["statistic.post.plural"] = "%s件の投稿";
...
$definitions["Unstarred"] = "フォローしていません";
...
$definitions["Username or Email"] = "ユーザー名 or メール";
...
$definitions["View your profile"] = "自分のプロフィールを見る";
