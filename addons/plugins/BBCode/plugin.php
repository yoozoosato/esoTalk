 ...
 */
class Plugin_BBCode extends Plugin {
	...
	public function __construct($directory)
	{
		...
		$self = $this;
		IoC::register('controllers.test', function($c) use ($self)
		{
			require 'controller.php';
			$controller = new My_User_Controller();
...
// 	// Images: [img]url[/img]
// 	$sender->content = preg_replace("/\[img\](.*?)\[\/img\]/i", "<img src='$1' alt='-image-'/>", $sender->content);
...
// 	// Headers: [h]header[/h]
// 	if (!$sender->basic) $sender->content = preg_replace("/\[h\](.*?)\[\/h\]/", "</p><h4>$1</h4><p>", $sender->content);
// }
